...
function verifyPassword(password) {
    // Send the password to your server for verification
    // Replace this with your actual server verification logic
    if (password === "root") {
        // Password is correct, redirect to the next page
        window.location.href = "next_page.html"; // Replace with your desired page
    } else {
